...
def train_perceptron(train_file, test_file, eta=0.1, maxit=100):
    """
    Train a Perceptron and evaluate it on the test set.
    """
...
def process_all_datasets(data_dir, eta=0.1, maxit=100):
    """
...
if __name__ == "__main__":
    ...
    process_all_datasets(data_directory, eta=0.1, maxit=100)