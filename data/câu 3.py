...
def train_and_evaluate(train_file, test_file, classifier, classifier_name):
    """
    ...
    print(f"\n📊 Results for {dataset_name} using {classifier_name}:")
        ...
        if os.path.isdir(dataset_path):  # Ensure it's a directory
            ...
            if os.path.exists(train_file) and os.path.exists(test_file):
                for classifier, classifier_name in classifiers:
                    train_and_evaluate(train_file, test_file, classifier, classifier_name)
            else:
